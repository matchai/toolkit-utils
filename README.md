...
- [API](#api)
  ...
  - [Project](#project)
    ...
    - [new Project([options])](#new-projectoptions-1)
    ...
    - [project.srcDir](#projectsrcdir-1)
    - [project.scriptsDir](#projectscriptsdir-1)
    - [project.configDir](#projectconfigdir-1)
    - [project.toolkitName](#projecttoolkitname-1)
    - [project.toolkitRootDir](#projecttoolkitrootdir-1)
    - [project.name](#projectname-1)
    - [project.package](#projectpackage-1)
    - [project.isCompiled](#projectiscompiled-1)
    - [project.isTypeScript](#projectistypescript-1)
    - [project.toolkitBin](#projecttoolkitbin-1)
    - [project.availableScripts](#projectavailablescripts-1)
    ...
    - [project.fromRoot(...part) ⇒](#projectfromrootpart-%E2%87%92-1)
    - [project.fromToolkitRoot(...part) ⇒](#projectfromtoolkitrootpart-%E2%87%92-1)
    - [project.fromConfigDir(...part) ⇒](#projectfromconfigdirpart-%E2%87%92-1)
    - [project.fromScriptsDir(...part) ⇒](#projectfromscriptsdirpart-%E2%87%92-1)
    - [project.hasAnyDep(deps) ⇒](#projecthasanydepdeps-%E2%87%92-1)
    - [project.envIsSet(name) ⇒](#projectenvissetname-%E2%87%92-1)
    - [project.parseEnv(name, defaultValue) ⇒](#projectparseenvname-defaultvalue-%E2%87%92-1)
    - [project.packageHas(jsonPath) ⇒](#projectpackagehasjsonpath-%E2%87%92-1)
    - [project.packageGet(jsonPath) ⇒](#projectpackagegetjsonpath-%E2%87%92-1)
    - [project.packageSet(jsonPath, value)](#projectpackagesetjsonpath-value-1)
    - [project.hasScript(scriptFile) ⇒](#projecthasscriptscriptfile-%E2%87%92-1)
    - [project.hasAnyFile(fileNames)](#projecthasanyfilefilenames-1)
    - [project.writeFile(fileName, data)](#projectwritefilefilename-data-1)
    - [project.copyFile(sourceFile, newFile)](#projectcopyfilesourcefile-newfile-1)
    - [project.bin(executable)](#projectbinexecutable-1)
    - [project.getConcurrentlyArgs(scripts, killOthers) ⇒](#projectgetconcurrentlyargsscripts-killothers-%E2%87%92-1)
    - [project.executeScriptFile(scriptFile, args)](#projectexecutescriptfilescriptfile-args-1)
    - [project.executeFromCLI(exit) ⇒](#projectexecutefromcliexit-%E2%87%92-1)
    - [project.execute(...executables) ⇒ <code>IScriptResult</code>](#projectexecuteexecutables-%E2%87%92-codeiscriptresultcode-1)
  - [Project](#project-1)
    - [new Project([options])](#new-projectoptions-2)
    - [new Project([options])](#new-projectoptions-3)
    - [project.srcDir](#projectsrcdir-2)
    - [project.scriptsDir](#projectscriptsdir-2)
    - [project.configDir](#projectconfigdir-2)
    - [project.toolkitName](#projecttoolkitname-2)
    - [project.toolkitRootDir](#projecttoolkitrootdir-2)
    - [project.name](#projectname-2)
    - [project.package](#projectpackage-2)
    - [project.isCompiled](#projectiscompiled-2)
    - [project.isTypeScript](#projectistypescript-2)
    - [project.toolkitBin](#projecttoolkitbin-2)
    - [project.availableScripts](#projectavailablescripts-2)
    - [project.srcDir](#projectsrcdir-3)
    - [project.scriptsDir](#projectscriptsdir-3)
    - [project.configDir](#projectconfigdir-3)
    - [project.toolkitName](#projecttoolkitname-3)
    - [project.toolkitRootDir](#projecttoolkitrootdir-3)
    - [project.name](#projectname-3)
    - [project.package](#projectpackage-3)
    - [project.isCompiled](#projectiscompiled-3)
    - [project.isTypeScript](#projectistypescript-3)
    - [project.toolkitBin](#projecttoolkitbin-3)
    - [project.availableScripts](#projectavailablescripts-3)
    - [project.fromRoot(...part) ⇒](#projectfromrootpart-%E2%87%92-2)
    - [project.fromToolkitRoot(...part) ⇒](#projectfromtoolkitrootpart-%E2%87%92-2)
    - [project.fromConfigDir(...part) ⇒](#projectfromconfigdirpart-%E2%87%92-2)
    - [project.fromScriptsDir(...part) ⇒](#projectfromscriptsdirpart-%E2%87%92-2)
    - [project.hasAnyDep(deps) ⇒](#projecthasanydepdeps-%E2%87%92-2)
    - [project.envIsSet(name) ⇒](#projectenvissetname-%E2%87%92-2)
    - [project.parseEnv(name, defaultValue) ⇒](#projectparseenvname-defaultvalue-%E2%87%92-2)
    - [project.packageHas(jsonPath) ⇒](#projectpackagehasjsonpath-%E2%87%92-2)
    - [project.packageGet(jsonPath) ⇒](#projectpackagegetjsonpath-%E2%87%92-2)
    - [project.packageSet(jsonPath, value)](#projectpackagesetjsonpath-value-2)
    - [project.hasScript(scriptFile) ⇒](#projecthasscriptscriptfile-%E2%87%92-2)
    - [project.hasAnyFile(fileNames)](#projecthasanyfilefilenames-2)
    - [project.writeFile(fileName, data)](#projectwritefilefilename-data-2)
    - [project.copyFile(sourceFile, newFile)](#projectcopyfilesourcefile-newfile-2)
    - [project.bin(executable)](#projectbinexecutable-2)
    - [project.getConcurrentlyArgs(scripts, killOthers) ⇒](#projectgetconcurrentlyargsscripts-killothers-%E2%87%92-2)
    - [project.executeScriptFile(scriptFile, args)](#projectexecutescriptfilescriptfile-args-2)
    - [project.executeFromCLI(exit) ⇒](#projectexecutefromcliexit-%E2%87%92-2)
    - [project.execute(...executables) ⇒ <code>IScriptResult</code>](#projectexecuteexecutables-%E2%87%92-codeiscriptresultcode-2)
    - [project.fromRoot(...part) ⇒](#projectfromrootpart-%E2%87%92-3)
    - [project.fromToolkitRoot(...part) ⇒](#projectfromtoolkitrootpart-%E2%87%92-3)
    - [project.fromConfigDir(...part) ⇒](#projectfromconfigdirpart-%E2%87%92-3)
    - [project.fromScriptsDir(...part) ⇒](#projectfromscriptsdirpart-%E2%87%92-3)
    - [project.hasAnyDep(deps) ⇒](#projecthasanydepdeps-%E2%87%92-3)
    - [project.envIsSet(name) ⇒](#projectenvissetname-%E2%87%92-3)
    - [project.parseEnv(name, defaultValue) ⇒](#projectparseenvname-defaultvalue-%E2%87%92-3)
    - [project.packageHas(jsonPath) ⇒](#projectpackagehasjsonpath-%E2%87%92-3)
    - [project.packageGet(jsonPath) ⇒](#projectpackagegetjsonpath-%E2%87%92-3)
    - [project.packageSet(jsonPath, value)](#projectpackagesetjsonpath-value-3)
    - [project.hasScript(scriptFile) ⇒](#projecthasscriptscriptfile-%E2%87%92-3)
    - [project.hasAnyFile(fileNames)](#projecthasanyfilefilenames-3)
    - [project.writeFile(fileName, data)](#projectwritefilefilename-data-3)
    - [project.copyFile(sourceFile, newFile)](#projectcopyfilesourcefile-newfile-3)
    - [project.bin(executable)](#projectbinexecutable-3)
    - [project.getConcurrentlyArgs(scripts, killOthers) ⇒](#projectgetconcurrentlyargsscripts-killothers-%E2%87%92-3)
    - [project.executeScriptFile(scriptFile, args)](#projectexecutescriptfilescriptfile-args-3)
    - [project.executeFromCLI(exit) ⇒](#projectexecutefromcliexit-%E2%87%92-3)
    - [project.execute(...executables) ⇒ <code>IScriptResult</code>](#projectexecuteexecutables-%E2%87%92-codeiscriptresultcode-3)
